...
const NetlifyGuide = () => {
  return (
    <div className="netlify-guide-container">
      ...
      <p>
        Once logged in, click on the "New site from Git" button. This will allow you to connect your GitHub repository to Netlify for deployment. The image below shows how to select your repository.
      </p>
      <img src={netlify2} alt="Create a New Site on Netlify" className="guide-image" />

      <h3>Step 3: Deploy Your Site</h3>
      <p>
      ...
      <h3>Step 4: Access Your Deployed Site</h3>
      <p>
